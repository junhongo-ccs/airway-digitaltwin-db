...
int spatial_ids_on_points(int argc, char* argv[]) {
    ...
    std::string str_crs = argv[3];
    std::string str_zoom = argv[4];
    ...
    try {
        spatialid::get_spatial_ids_on_points(point_list, spatial_id_list, zoom, crs);
    }
