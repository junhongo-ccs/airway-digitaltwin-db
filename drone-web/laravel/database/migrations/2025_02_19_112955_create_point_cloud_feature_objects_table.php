...
return new class extends Migration
{
    ...
    {
        Schema::create('point_cloud_feature_objects', function (Blueprint $table) {
            $table->unsignedBigInteger('point_cloud_feature_object_id')->comment('点群地物情報空間ID')->autoIncrement();
            ...
            $table->integer('data_source_id')->comment('空間座標系');
            $table->string('update_memo',1000)->nullable()->comment('元データ情報ID');
    ...
    {
        Schema::dropIfExists('point_cloud_feature_objects');
    }
};
