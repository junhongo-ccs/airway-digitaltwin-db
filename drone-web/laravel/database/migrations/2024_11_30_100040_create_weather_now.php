...
return new class extends Migration
{
    ...
    {
        Schema::create('weather_now', function (Blueprint $table) {
            $table->unsignedBigInteger('weather_now_id')->comment('気象実況情報ID')->autoIncrement();
            ...
            $table->string('basetime', 255)->comment('気象実況情報発表時間');
            $table->string('name')->comment('実況解析データ型名');
            $table->text('contents')->comment('実況データ');
    ...
    {
        Schema::dropIfExists('weather_now');
    }
};
