...
return new class extends Migration
{
    ...
    {
        Schema::create('drone_route_detail_objects', function (Blueprint $table) {
            $table->unsignedBigInteger('id')->comment('サロゲートキー')->autoIncrement();
            $table->unsignedBigInteger('drone_route_info_id')->comment('ドローン航路情報ID');
    ...
    {
        Schema::dropIfExists('drone_route_detail_objects');
    }
};
