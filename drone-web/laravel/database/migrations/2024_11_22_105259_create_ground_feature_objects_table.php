...
return new class extends Migration
{
    ...
    {
        Schema::create('ground_feature_objects', function (Blueprint $table) {
            $table->unsignedBigInteger('ground_feature_object_id')->comment('地物・障害物情報空間ID')->autoIncrement();
            ...
            $table->integer('object_cd')->comment('地物タイプコード');
            ...
            $table->integer('data_source_id')->comment('元データ情報ID');
    ...
    {
        Schema::dropIfExists('ground_feature_objects');
    }
};
